                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" id="form" action="php_action/store/location.php" method="POST"
                                    enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleTitle"> New Location </label>
      ...
      ?>
                  ...
                  ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="php_action/delete/location.php?location_id=<?php echo $row['location_id']; ?>"
