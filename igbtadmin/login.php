...
<body>
    <div class="container">
        ...
        <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
            ...
            <div class="panel panel-default">
                <div align="center"><img src="reslogo.jpg" /></div>
                <div class="panel-heading">

                    <div class="panel-title text-center"><?php //echo $system_name; ?></div>
                </div>

                <div class="panel-body">

                    <form name="form" id="form" action="<?php echo $_SERVER['PHP_SELF'] ?>" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 controls">
                                <button type="submit" href="#" class="btn btn-danger center-block"><i
    ...
    ! function(a) {
        function b(b, d) {
            function e() {
                if (w) {
                    ...
                    a(window).on("resize", function() {
                        ...
                        D = Math.min(Math.max(-event.beta, -30), 30), C = Math.min(Math.max(-event.gamma, -30),
                            30)
                    }, !0), g(), o("onInit")
                }
            }
            ...
            function h() {
                for (f(), i = x.length - 1; i >= 0; i--)(x[i].position.x > v.width() || x[i].position.y > v.height()) &&
                    x.splice(i, 1);
            ...
            return d = a.extend({}, a.fn[c].defaults, d), l.prototype.draw = function() {
                q.beginPath(), q.arc(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY,
                    d.particleRadius / 2, 0, 2 * Math.PI, !0), q.closePath(), q.fill(), q.beginPath();
                ...
                if (d.parallax) {
                    ...
                    this.parallaxTargX = (pointerX - s / 2) / (d.parallaxMultiplier * this.layer), this
                        .parallaxOffsetX += (this.parallaxTargX - this.parallaxOffsetX) / 10, this.parallaxTargY = (
                            pointerY - t / 2) / (d.parallaxMultiplier * this.layer), this.parallaxOffsetY += (this
                            .parallaxTargY - this.parallaxOffsetY) / 10
                }
                switch (d.directionX) {
                    case "left":
                        this.position.x + this.speed.x + this.parallaxOffsetX < 0 && (this.position.x = v.width() -
                            this.parallaxOffsetX);
                        break;
                    case "right":
                        this.position.x + this.speed.x + this.parallaxOffsetX > v.width() && (this.position.x = 0 -
                            this.parallaxOffsetX);
                        break;
                    default:
                        (this.position.x + this.speed.x + this.parallaxOffsetX > v.width() || this.position.x + this
                            .speed.x + this.parallaxOffsetX < 0) && (this.speed.x = -this.speed.x)
                }
                switch (d.directionY) {
                    case "up":
                        this.position.y + this.speed.y + this.parallaxOffsetY < 0 && (this.position.y = v.height() -
                            this.parallaxOffsetY);
                        break;
                    case "down":
                        this.position.y + this.speed.y + this.parallaxOffsetY > v.height() && (this.position.y = 0 -
                            this.parallaxOffsetY);
                        break;
                    default:
        ...
        a.fn[c] = function(d) {
            if ("string" == typeof arguments[0]) {
                ...
                return this.each(function() {
                    a.data(this, "plugin_" + c) && "function" == typeof a.data(this, "plugin_" + c)[f] && (
