...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="sales-add.php"><i class="fa fa-cart-plus"></i> Change Home Page Banner 1</a></li> 
    ...
    <li><a href="db/db_export.php" target="_blank"><i class="fa fa-download"></i> <span>Backup</span></a></li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="sales-add.php"><i class="fa fa-cart-plus"></i> Sale</a></li> 
			<li><a href="sales-addnp.php"><i class="fa fa-cart-plus"></i> Sale no Print</a></li> 
