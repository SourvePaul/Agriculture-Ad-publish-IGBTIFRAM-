    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <a href="footer-image-add.php" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add Footer
                    Image</a>
                <br></br>
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $no=1;
                                        $sql = "SELECT * FROM footer_image ORDER BY f_id DESC";  
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="images/footer/<?php echo $row['footer_top_image']; ?>"
                                            ...
                                            <td>
                                                ...
                                                $f_id = $row['f_id'];
                                                if($f_status == 1) { 
                                                    echo "<a  href=php_action/store/deactive-footer-image.php?id=".$f_id."><button type='button' class='btn btn-danger'>Deactivate</button></a>"; } 
                                                else if($f_status == 0){
                                                echo "<a href=php_action/store/active-footer-image.php?id=".$f_id."><button type='button' class='btn btn-primary'>Activate</button></a>";
                                                }?>
                                            </td>
                                            <td>
                                        ...
                                        <?php 
                                            if(isset($_GET['f_status'])) {
                                                ...
                                                $mysqli->query("UPDATE userlogin SET f_status='$f_status' WHERE f_id='$f_id'") or die($mysqli->error());
