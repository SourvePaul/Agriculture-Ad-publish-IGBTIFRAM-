      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="php_action/store/product-sub-category.php" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Sub Category Name</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="sub_cat_name" required>
                </div>
				     <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="sub_cat_desc"></textarea> 
                </div> 
              </div>
              <!-- /.box-body -->
