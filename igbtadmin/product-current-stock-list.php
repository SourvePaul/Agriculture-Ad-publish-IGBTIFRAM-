...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <a href="product-low-stock.php" class="btn btn-danger"><i class="fa fa-bell-slash"></i> Low Stock </a>
	  <a href="product-add.php" class="btn btn-success pull-right"><i class="fa fa-plus-circle"></i> Add New Product</a>
