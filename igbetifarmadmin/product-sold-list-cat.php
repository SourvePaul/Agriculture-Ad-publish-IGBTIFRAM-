      ...
      <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                  ...
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form role="form" action="product-sold-list-cat.php" method="get">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <select class="form-control select2" name="cat_id2">
                        <option value="">--Select--</option>
                        <?php
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  $cat_id2 = $_GET['cat_id2'];
                         $p_sql = "SELECT product_name FROM products WHERE cat_id = '$cat_id2' AND product_id = '$single_product[$srl]'";
                  ...
                  <td><?php 
                         $p_sql = "SELECT product_purchase_price FROM products WHERE cat_id = '$cat_id2' AND product_id = '$single_product[$srl]'";
                         $p_result = $connection->query($p_sql);                 
                          while($p_row = $p_result->fetch_assoc()) {  
                           echo "BDT ".$p_row['product_purchase_price']; 
                          } 
                      ?>
                  </td> 
                  ...
                  <td>
                  <a target="_blank" href="print_bill.php?order_id=<?php echo $row['order_id']; ?>"><?php echo $row['order_id']; ?></a>
                  </td>
                  <td>
                     <?php 
                ...
                <tr>
                  ...
                  <td><?php 
                         ...
                         $p_result = $connection->query($p_sql);                 
                          while($p_row = $p_result->fetch_assoc()) {  
                           echo "BDT ".$p_row['product_purchase_price']; 
                           $totoal = $total + $p_row['product_purchase_price']; 
                          } 
                      ?>
                  </td> 
                  <td><?php echo "BDT ".$single_rate[$srl];; ?></td>  
                  ...
                  <td><?php echo "BDT ".($single_rate[$srl]*$single_quantity[$srl]); ?></td>
                  <td>
                  <a target="_blank" href="invoice-print.php?order_id=<?php echo $row['order_id']; ?>"><?php echo $row['order_id']; ?></a>
                  </td>
                  <td>
                     <?php 
                         $p_sql = "SELECT date FROM orders WHERE order_id = ".$row['order_id'];
