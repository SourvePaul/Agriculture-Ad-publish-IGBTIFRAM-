...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
            ...
            if(unit == "") {
                $("#productUnit").after('<p class="text-danger">Unit field is required</p>');
                $('#productUnit').closest('.form-group').addClass('has-error');
            }	else {
                // remov error text field
                $("#productUnit").find('.text-danger').remove();
                // success out for form
                $("#productUnit").closest('.form-group').addClass('has-success');
            }
	...
	if(productId) {
		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				//details
                $("#editDetail").val(response.detail);
                //config
                $("#editConfig").val(response.config);
                //publish To web
                $("#editPublishToWeb").val(response.publish_to_web);
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
                    ...
                    var productDetail = $("#editDetail").val();
                    var productConfig = $("#editConfig").val();
                    var publish = $("#editPublishToWeb").val();
                    ...
                    if(productDetail == "") {
                        $("#productDetail").after('<p class="text-danger">Product Details field is required</p>');
                    ...
                    if(productConfig == "") {
                        $("#editConfig").after('<p class="text-danger">Product Configuration field is required</p>');
                        $('#editConfig').closest('.form-group').addClass('has-error');
                    }	else {
                        // remov error text field
                        $("#editConfig").find('.text-danger').remove();
                        // success out for form
                        $("#editConfig").closest('.form-group').addClass('has-success');
                    }
