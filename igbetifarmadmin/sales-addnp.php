...
$.post("php_action/store/cart2.php", //Required URL of the page on server
...
?>
  ...
  <div class="content-wrapper">
            ...
            <!-- form start -->
              ...
              <tbody>
                <tr>
                  ...
                  <form role="form" id="" action="php_action/store/cart2.php" method="POST" enctype="multipart/form-data">
    ...
    <tbody>
        <tr>
            <td class="">
                  <select class="form-control select2" onChange="checkProductRate()" id="product_id[]" name="product_id[]" required="">
    ...
    <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="box-body">
              <form role="form" action="php_action/store/order2.php" method="POST">
                 <div class="form-group">
