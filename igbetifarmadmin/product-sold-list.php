  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <a target="_blank" class="btn btn-info pull-right" href="reporting/product-sold-list-report.php?product_id=<?php echo $_GET['product_id'];?>&start_date=<?php echo $_GET['start_date'];?>&end_date=<?php echo $_GET['end_date'];?>"><i class="fa fa-print"></i> Full Summery</a>
      </h1>
    </section>
      ...
      <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                  ...
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form role="form" action="product-sold-list.php" method="get">
                    <div class="box-body">
