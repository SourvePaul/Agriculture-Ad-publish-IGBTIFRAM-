      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="form" action="php_action/update/staff.php" method="POST" enctype="multipart/form-data">
              <div class="box-body">
              <input type="hidden"  value="<?php echo $staff_id?>" name="staff_id">
               <div class="form-group">
                  <label for="exampleInputEmail1">Name</label>
                  <input type="text" class="form-control" value="<?php echo $staff_name; ?>" name="staff_name" required>
                </div>
                 <div class="form-group">
                  <label for="exampleInputEmail1">NID/Birth Certificate No</label>
                  <input type="number" class="form-control" value="<?php echo $identification_no; ?>" name="identification_no" required>
                </div>
                <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <input type="file" class="form-control" id="" accept="image/*" name="staff_image" required="">
                </div> 
