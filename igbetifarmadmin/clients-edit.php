      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="php_action/update/client.php" method="post">
              <div class="box-body">
              <div class="box-body">
              ...
              <input type="hidden"  value="<?php echo $cust_id?>" name="cust_id">
			   <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="" value="<?php echo $cust_name; ?>" name="cust_name">
                </div>

				<div class="form-group">
                  <label for="exampleInputEmail1">Address</label>
                  <input type="text" class="form-control" value="<?php echo $cust_add; ?>" name="cust_add">
                </div>
				<div class="form-group">
                  <label for="exampleInputEmail1">Phone</label>
                  <input type="text" class="form-control" id="" value="<?php echo $cust_phone; ?>" name="cust_phone">
        </div>
        <div class="form-group">
