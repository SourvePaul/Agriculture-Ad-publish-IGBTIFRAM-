                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" id="form" action="php_action/store/banner.php" method="POST"
                                    enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Home Page Banner Top </label>
                                            <input type="file" class="form-control" id="" accept="image/*"
                                                name="banner_img" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleTitle"> Banner Title </label>
      ...
      ?>
                  ...
                  ?>
                                    <tr>
                                        ...
                                        <td><img src="images/banner/<?php echo $row['banner_img']; ?>" height="100"
                                                width="100"></td>
                                        <td><?php echo $row['banner_title']; ?></td>
                                        <td><?php echo $row['cat_id']; ?></td>
                                        <td><?php echo $row['publish']; ?></td>
                                        <td>
                                            <a href="php_action/delete/banner.php?bannre_id=<?php echo $row['bannre_id']; ?>"
                                                title="Delete" class="btn btn-warning">Delete</a>
                                        </td>
                                    </tr>
                                    <?php  } ?>
