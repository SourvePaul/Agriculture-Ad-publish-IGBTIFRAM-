...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <!-- left column -->
        <form role="form" id="form" action="php_action/store/product.php" method="POST" enctype="multipart/form-data">
        <div class="col-md-6">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="product_name" required>
                </div>
                 <div class="form-group">
                  <label for="exampleInputEmail1">Product Code</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="product_code" required>
                </div>
                <div class="form-group">
                ...
                <select class="form-control " name="sub_cat_id" id="subcategory-select">
                  ...
                  <input type="number" class="form-control" id="exampleInputEmail1" name="product_qty" required>
                </div>  
              </div>
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="exampleInputEmail1" name="product_purchase_price" required> 
                </div>
        <div class="form-group">
                  <label for="exampleInputEmail1">Selling Price (Per Unit)</label>
                  <input type="number" class="form-control" id="exampleInputEmail1" name="product_selling_price" required>
                </div>
         <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <input type="file" class="form-control" id="" accept="image/*" name="product_image" >
                </div> 
