      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="php_action/store/wastage.php" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <textarea rows="2" class="form-control" name="details"></textarea>
                </div>
                 <div class="form-group">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-download"></i> Save</button>
              </div>
            </form>
          </div>
        <?php  
              ...
              ?> 
                ...
                <tr>
                  <td>
                      <?php 
                        $id = $row['product_id'];
                        $p_sql = "SELECT * from products where product_id = '$id' ";  
