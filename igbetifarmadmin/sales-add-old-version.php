  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <tbody>
                ...
                <div class="form-group">
                <br>
                 <button type="submit" id="btn" class="btn btn-success pull-right" ><i class="fa fa-plus-circle"></i></button> 
                 </div>
                 </form>
                </td>
        ...
        ?>
         <script>window.open('pos.php?order_id=<?php echo $last_ordered_item; ?>');</script> 
               <?php }
        ?>
