                                            ...
                                            <section class="content">
                                                ...
                                                <div class="listing__products" id="product_list">
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            class="col-12 col-xl-12 col-md-12 col-sm-12 listing__products__box">
                                                            <div class="row no-gutters">
                                                                <div
                                                                    class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 listing__products__image">
                                                                    <img src="igbtadmin/images/advertisement/<?php echo $row['ad_feature_image']; ?>"
                                                                        alt="<?php echo $row['ad_id']; ?>"
                                                                        class="card-img" width="360">
                                                                    <?php 
                                                                        if ($counter <= 2) {
                                                                        ?>
                                                                    <div
                                                                        class="product-badges product-badges-position product-badges-mrg">
                                                                        <span class="badge rounded-pill hot"
                                                                            style="background-color:#8a288f;">TOP
                                                                            AD</span>
                                                                    </div>
